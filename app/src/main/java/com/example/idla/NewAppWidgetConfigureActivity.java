...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(com.example.idla.R.layout.new_app_widget_configure);
        mAppWidgetText = (EditText) findViewById(com.example.idla.R.id.appwidget_text);
        findViewById(com.example.idla.R.id.add_button).setOnClickListener(mOnClickListener);
